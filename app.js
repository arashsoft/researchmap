...
app.get("/grantpub/analysis/:proposal_ID/:keyword_filter_array/:name_filter_array/:begin_date/:end_date/:algorithm_selection/:author_correlation/:aggregation/:keyword_correlation/:numberOfTopics/:numberOfKeywords/:threshold",function(req, res) {
	if (req.isAuthenticated()){
